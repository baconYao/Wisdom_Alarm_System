<?php
  ...
  if(!empty($account) && !empty($password1) && !empty($password2) && !empty($email)){
    ...
    if(mysqli_num_rows($dataTampEmail) == 0 && mysqli_num_rows($dataEmail) == 0){         //信箱無人使用
      ...
      $query = "INSERT INTO tampuser (passwd,email,validate,code,account) VALUES (SHA('$password1'),'$email',0,'$randcode','$account')";        
